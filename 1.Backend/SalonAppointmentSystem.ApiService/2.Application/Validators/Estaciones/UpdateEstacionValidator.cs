...
/// <summary>
/// Validador para la actualización de estaciones
/// </summary>
public class UpdateEstacionValidator : AbstractValidator<UpdateEstacionRequest>
{
    public UpdateEstacionValidator()
    {
        RuleFor(x => x.Nombre)
